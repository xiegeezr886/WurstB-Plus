...
import net.wurstclient.mixin.SwingStateAccessor;
	...
	implements UpdateListener, HandleInputListener, RenderListener
{
	...
	private boolean canBlock(Entity target)
	{
		...
		if(target instanceof LivingEntity living
			&& ((SwingStateAccessor)((LivingEntityAccessor)living)
				.wurst_getSwingState()).wurst_getTicks()
		...
		private Comparator<Entity> comparator(MultiAuraHack aura)
		{
			return switch(this)
			{
				...
				case HURT_RESISTANCE -> Comparator.comparingInt(entity ->
					entity instanceof LivingEntity living ? living.getInvulnerableTime() : 0);
