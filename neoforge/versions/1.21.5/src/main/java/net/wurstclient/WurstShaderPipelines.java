...
public enum WurstShaderPipelines
{
	 ...
	 */
	public static final RenderPipeline ONE_PIXEL_LINES = positionColor(
		"wurst_one_pixel_lines", Mode.DEBUG_LINES, true);
	 ...
	 */
	public static final RenderPipeline QUADS = positionColor("wurst_quads",
		Mode.QUADS, true);
	...
	{
		// NeoForge patches RenderPipelines.register() down to private, so put
		// the pipeline into the same map it uses.
