...
public final class CmdProcessor implements ChatOutputListener
{
	...
	public void onSentMessage(ChatOutputEvent event)
	{
		if(!WurstClient.INSTANCE.isEnabled()
			|| !WurstClient.INSTANCE.getGuiPreferences().isCommandsEnabled())
			return;
	...
	private void runCmd(Command cmd, String input)
	{
		...
		{
			CrashReport report = CrashReport.forThrowable(e, "Running Wurst command");
			CrashReportCategory section = report.addCategory("Affected command");
