...
import net.wurstclient.mixin.EntityMaxUpStepAccessor;
...
public final class StepHack extends Hack implements UpdateListener
{
	...
	public void onUpdate()
	{
		...
		{
			((EntityMaxUpStepAccessor)(Object)player).wurst_setMaxUpStep(height.getValueF());
			return;
		}
		
		((EntityMaxUpStepAccessor)(Object)player).wurst_setMaxUpStep(previousStepHeight);
	...
	private void trackPlayer(LocalPlayer player)
	{
		...
		previousStepHeight = ((EntityMaxUpStepAccessor)(Object)player).wurst_getMaxUpStep();
	}

	private void restoreTrackedPlayer()
	{
		if(trackedPlayer != null)
			((EntityMaxUpStepAccessor)(Object)trackedPlayer).wurst_setMaxUpStep(previousStepHeight);
		trackedPlayer = null;
	}
