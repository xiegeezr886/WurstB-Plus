...
import net.wurstclient.clickgui2.screens.EditBlockListScreen;
	...
	ShouldDrawSideListener, RenderBlockEntityListener
{
	...
	private String checkOptiFine()
	{
		...
		if(PlatformUtils.getLoadedModIds().stream()
			.anyMatch(optifine.asPredicate()))
	...
	{
		MC.setScreenAndShow(new EditBlockListScreen(prevScreen, ores));
	}
