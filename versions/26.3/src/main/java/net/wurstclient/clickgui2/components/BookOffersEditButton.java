...
import net.wurstclient.clickgui2.screens.EditBookOffersScreen;
...
public final class BookOffersEditButton extends AbstractListEditButton
{
	...
	{
		MC.setScreenAndShow(new EditBookOffersScreen(MC.gui.screen(), setting));
	}
	
	@Override
	protected String getText()
	{
		return setting.getTranslatedName() + ": " + setting.getOffers().size();
	}
