...
public final class TextFieldEditButton extends Component
{
	...
	public void handleMouseClick(double mouseX, double mouseY, int mouseButton)
	{
		...
		switch(mouseButton)
		{
			...
			MC.setScreenAndShow(new EditTextFieldScreen(MC.gui.screen(), setting));
			break;
		...
		float partialTicks)
	{
		...
		context.text(TR, setting.getTranslatedName(), x1, y1 + 2, txtColor, false);
	...
	{
		return TR.width(setting.getTranslatedName()) + 4;
	}
