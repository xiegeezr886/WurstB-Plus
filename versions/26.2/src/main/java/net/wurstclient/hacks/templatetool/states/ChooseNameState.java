...
public final class ChooseNameState extends TemplateToolState
{
	...
	{
		MC.setScreenAndShow(new ChooseNameScreen(hack));
	}
	...
	public static final class ChooseNameScreen extends Screen
	{
		...
		public void init()
		{
			...
			nameField = new EditBox(tr, middleX - 99, middleY + 16, 198,
				16, Component.empty());
		...
		@Override
		public void extractBackground(GuiGraphicsExtractor context, int mouseX, int mouseY,
			float partialTicks)
		{
			// Don't blur
		}
