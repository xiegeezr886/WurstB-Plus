...
public enum PacketUtils
{
	 ...
	 */
	public static ServerboundMovePlayerPacket modifyPosition(ServerboundMovePlayerPacket packet,
	 ...
	 */
	public static ServerboundMovePlayerPacket modifyRotation(ServerboundMovePlayerPacket packet,
	 ...
	 */
	public static ServerboundMovePlayerPacket modifyOnGround(ServerboundMovePlayerPacket packet,
		boolean onGround)
	{
		if(packet instanceof PosRot)
