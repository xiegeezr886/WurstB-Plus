...
public enum InteractionSimulator
{
	 ...
	 * hand, use {@link #rightClickBlock(BlockHitResult, InteractionHand, SwingHand)}
	 * instead.
	 *
	 * <p>
	 ...
	 */
	public static void rightClickBlock(BlockHitResult hitResult, InteractionHand hand)
	{
