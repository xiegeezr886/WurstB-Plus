	...
	implements UpdateListener
{
	...
	public void render(GuiGraphics graphics, int x, int y, float partialTicks)
	{
		...
		if(textureLocation != null)
			graphics.blit(RenderType.GUI_TEXTURED, textureLocation, x + PADDING, y + PADDING, 0, 0,
	...
	private void ensureTexture()
	{
		...
		textureLocation = WurstClient.MC.getTextureManager()
			.register("wurstb_minimap", texture);
	}
