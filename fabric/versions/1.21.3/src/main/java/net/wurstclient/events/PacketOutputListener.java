...
public interface PacketOutputListener extends Listener
{
		...
		extends CancellableEvent<PacketOutputListener>
	{
		...
		private final ArrayList<Runnable> afterSendActions = new ArrayList<>();
		...
		public void runAfterSend(Runnable action)
		{
			afterSendActions.add(Objects.requireNonNull(action));
		}

		public void notifySent()
		{
			for(Runnable action : List.copyOf(afterSendActions))
				action.run();
			afterSendActions.clear();
		}
