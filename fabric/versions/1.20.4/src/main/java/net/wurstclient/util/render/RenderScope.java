...
public final class RenderScope implements AutoCloseable
{
	...
	private final BufferBuilder sharedBuilder;
	private final boolean builderWasBuilding;
	...
	private RenderScope()
	{
		...
		sharedBuilder = Tesselator.getInstance().getBuilder();
		builderWasBuilding = sharedBuilder.building();
	}
	...
	public void close()
	{
		...
		if(!builderWasBuilding && sharedBuilder.building())
			sharedBuilder.discard();
